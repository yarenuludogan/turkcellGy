...
INSERT INTO Book (Title, ISBN, Publish_Year, Page_Count, Author_Id, Publisher_Id, Category_Id)
VALUES ('Harry Potter', '1111', 1997, 320, 1, 1, 1),
...
VALUES ('Ali Yılmaz', 'ali@mail.com', '111111'),
...
INSERT INTO Return_Table (Loan_Id, Return_Date, Condition_Notes)
VALUES (1, '2024-01-09', 'Good'),
       (2, '2024-01-15', 'Late'),
       (3, '2024-01-12', 'Good'),
       (4, '2024-01-20', 'Damaged'),
       (5, '2024-01-14', 'Good');

INSERT INTO Fine (Loan_Id, Amount, Paid)
VALUES (2, 10.50, FALSE),
       (4, 25.00, TRUE),
       (1, 0.00, TRUE),
       (3, 0.00, TRUE),
       (5, 5.00, FALSE);
...
SELECT *
FROM Return_Table
WHERE Return_Date > '2024-01-10';
SELECT *
FROM Return_Table
WHERE Condition_Notes = 'Good';
SELECT *
FROM Return_Table
